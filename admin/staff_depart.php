...
$query_staff = "SELECT DISTINCT stf_depart FROM staff";
...
<div class="container">
  ...
  <div class="container">
    <?php do { ?>
      <p><a href="staff_list.php?stf_depart=<?php echo $row_staff['stf_depart']; ?>" class="btn btn-block btn-primary"><?php echo $row_staff['stf_depart']; ?></a></p>
