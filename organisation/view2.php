...
<center><img src="../img/logbook.png" width="750" height="150" alt="" class="img-fluid"/>
  <h3 class="text-center" style=" color:white; width:70%;background-color:brown">Student Profile</h3></center>
<br/>
<center><img src="<?php echo "../admin/".$image; ?>" style="border-radius:50%" height="150" width="150">
...
<td><a href="manageStudent.php" class="btn btn-danger">  Back   </a>
