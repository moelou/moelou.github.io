...
if(isset($_POST['grade'])){
		...
		mysqli_query($conn,"UPDATE student SET org_grade='$let' WHERE id='$id'")or die(mysqli_error); 
...
<div class="container">
   <h3 class="text-center" style=" color:white; width:100%;background-color:brown">LOGBOOK ACTIVITY </h3>
  ...
  <table class="table" style="color:black; background-color:white" width="70%" border="1">
    <tbody class="thead-light">
      <tr>
        <th style="color:white; background-color:brown" scope="col">Week</th>
        <th style="color:white; background-color:brown" scope="col">Start Week</th>
        <th style="color:white; background-color:brown" scope="col">End Week</th>
        <th style="color:white; background-color:brown" scope="col">View Activity</th>
        <th style="color:white; background-color:brown" scope="col">Comment</th>
        </tr>
    </tbody>
...
<a href="managestudent.php" class="btn btn-success">  Back   </a></td>
    </div>
