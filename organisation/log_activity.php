...
$result=mysqli_query($conn,"UPDATE week SET incomment='$comment' WHERE id='$id'")or die(mysqli_error); 
...
?>
      ...
      <table  style=" color:black; background-color:white" width="100%" border="1">
	    ...
	    <tbody>
          ...
          <tr>
             ...
             <td>Monday </td>
			 <td> <textarea name="desc1" rows="4"  cols="50"    required readonly><?php echo $day1;?></textarea>
			 </td>
		   ...
		   <td>Tuesday </td>
		  <td> <textarea name="desc2" rows="4"  cols="50"    required readonly><?php echo $day2;?></textarea>
			 </td>
		   ...
		   <tr>
			 <td>Wednesday </td>
			 <td> <textarea name="desc3"rows="4"  cols="50"     required readonly><?php echo $day3;?></textarea>
			 </td>
			...
			<tr>
			 <td>Thursday </td>
			<td> <textarea name="desc4" rows="4"  cols="50"    required readonly><?php echo $day4;?></textarea>
			 </td>
			 ...
			 <tr>
			 <td>Friday </td>
			 <td> <textarea name="desc5"rows="4"  cols="50"     required readonly><?php echo $day5;?></textarea>
			 </td>
    ...
    <table>
	  <form action="log_activity.php" Method="POST"  enctype="multipart/form-data">
			  <tr> Add Comment:
			  <td><textarea name="comment" rows="5" cols="80" placeholder="Add Comment" value="" required><?php echo $in;?></textarea></td>
