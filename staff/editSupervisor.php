...
if(isset($_POST['submit'])){
	...
	$result=mysqli_query($conn,"UPDATE supervisors SET name='$name',email='$email',phoneno='$phone',gender='$gender',username='$username',password='$password',image='$thumbnails' WHERE id='$id'")or die(mysqli_error); 
...
<br/>
<div class="container">
   <h3 class="text-center" style=" color:black; width:100%;background-color:white">Upadte Supervisor Details</h3></center>
  <div class="container">
  <form method="POST" action="editSupervisor.php"  enctype="multipart/form-data">
    <table width="75%" align="center" border="0" >
      <tbody>
        ...
        <a href="dashboard.php" class="btn btn-dark">Back</a></td>
        </tr>
      </tbody>
    </table>
