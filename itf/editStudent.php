...
if(isset($_POST['submit'])){
	...
	$result=mysqli_query($conn,"UPDATE student SET name='$name',matricno='$matricno',gender='$gender',department='$department',email='$email',phone='$phone',password='$password',image='$thumbnails' WHERE id='$id'")or die(mysqli_error); 
...
<div class="container">
 <center> <h5 style="color:white">Update Student Details</h5>
  <div class="container">
