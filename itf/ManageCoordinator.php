...
<br/>
<div class="container">
 <h5 style="color:white" >Coordinator List</h5>
  <a href="CoordinatorReg.php" class="btn btn-success">  ADD COORDINATOR   </a></td>
...
<th bgcolor="green" ><font face="Albertus MT" size="2" COLOR="WHITE"><center>Operations</th>
...
include_once('db/db.php');
$count =0;
$record=mysqli_query($conn,"select * from coordinators ")or die(mysqli_error);
    ...
    echo "<tr>";
     ...
     echo "<td> <font  size='2'>".strtoupper($rowfetch['name'])."</td>";
	   echo "<td><font  size='2'>".$rowfetch['username']."</td>";
			 ...
			 <td><center><a href="activatec.php?id=<?php echo $rowfetch['id'];?>" onclick="return confirm('Are you sure you want to Activate User?')"> Activate</a> | <a href="deactivatec.php?id=<?php echo $rowfetch['id'];?>" onclick="return confirm('Are you sure you want to 	Deactivate User?')"> Deactivate</a></td>
			  <td><center><font  size="2"><a href="viewc.php?id=<?php echo $rowfetch['id'];?>">View</a></td>
			  <td><center><font  size="2"><a href="editc.php?id=<?php echo $rowfetch['id'];?>">Edit</a></td>
			  <td><a href="del3.php?id=<?php echo $rowfetch['id'];?>" onclick="return confirm('Are you sure you want to Submit?')"> Delete</a></td>
