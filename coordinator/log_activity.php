...
$result=mysqli_query($conn,"UPDATE week SET codcomment='$comment' WHERE id='$id'")or die(mysqli_error); 
...
?>
    ...
    <table>
	  <form action="log_activity.php" Method="POST"  enctype="multipart/form-data">
			  <tr> Add Comment:
			  <td><textarea name="comment"  rows="5" cols="80" placeholder="Add Comment" value="" required><?php echo $cod;?></textarea></td>
