...
$app="1";
$querylogin=mysqli_query($conn,"SELECT *FROM coordinators WHERE username='$username' AND password='$password' and app='$app'")or die(mysqli_error);
...
<center><div class="container"  style=" border: 1px solid white; width:750px" >
  <h3 style="color:white">Departmental Coordinator's Login</h3>
  <div class="container" >
    ...
    <table width="55%" border="0">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="CoordinatorReg.php" class="btn btn-primary" style="width:45%"> Register </a>
