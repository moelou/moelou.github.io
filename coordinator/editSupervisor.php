...
include_once('db/db.php');
  $id=$_GET['id'];
  $query=mysql_query("select * from supervisors where id='$id'")or die(mysql_error);
...
if(isset($_POST['submit'])){
	...
	$result=mysql_query("UPDATE supervisors SET name='$name',email='$email',phoneno='$phone',gender='$gender',department='$department',username='$username',password='$password',image='$thumbnails' WHERE id='$id'")or die(mysql_error); 
...
<br/>
<div class="container">
  <center><h5>Upadte Supervisor Details</h5></center>
  <div class="container">
